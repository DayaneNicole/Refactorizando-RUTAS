...
$ejercicios = [
    [
        ...
        'imagen' => '../public/resources/img/ejercicio01.PNG',
        'link' => '../views/ejercicio01.php'
    ],
    ...
    [
        ...
        'imagen' => '../public/resources/img/ejercicio02.PNG',
        'link' => '../views/ejercicio02.php',
...
lista de clientes que se encuentra en un array de la siguiente forma. Adicionalmente se debe de mostrar un boton para poder regresar a la pagina principal',
        'imagen' => '../public/resources/img/ejercicio03.PNG',
        'link' => '../views/ejercicio03.php'
    ]
...
<body>
    <div class="container mx-auto"> <!-- CREAMOS EL CONTENEDOR PRINCIPAL -->
        ...
        <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <img src="../public/resources/img/banner.png" style="width: 100%" alt="...">
                </div>
            </div>
        </div>
        <!-- CREAMOS EL NAVBAR -->
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <!-- LOGO DE LA PAGINA -->
            <a class="navbar-brand" href="#"><img src="../public/resources/img/logoapp.png" width="80" height="80" alt=""></a>
            <!-- MENU DE NAVEGACION -->
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-link active pt-1 pb-1" href="/exam">Inicio</a>
    ...
    <script src="../public/resources/js/jquery-1.11.3.js"></script>
    <script src="../public/resources/js/bundle.min.js"></script>
